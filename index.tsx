    ...
    <div className="relative z-10 max-w-6xl w-full space-y-24 lg:space-y-32 animate-fade-in">
      <div className="text-center space-y-12">
        ...
        <div className="space-y-10">
          ...
          <p className="text-xl md:text-3xl text-white max-w-4xl mx-auto font-medium leading-relaxed">사람들이 검색으로 해결하려는 반복적인 문제의<br className="hidden md:block" />질문을 <span className="text-indigo-400 font-black text-2xl md:text-4xl">이플림의 아카이브</span>로 정제합니다.</p>
        </div>
      </div>
