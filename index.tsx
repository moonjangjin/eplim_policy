...
const GOVERNANCE_DATA = {
  constitution: [
    ...
    { id: 'c3', title: '3. DB 보안 ', description: '고객 및 조직의 민감 정보는 AGI 시스템에 입력하지 않으며, 개인정보보호법 및 데이터 보호 규정을 철저히 준수한다.' },
    ...
    <div className="relative z-10 max-w-6xl w-full space-y-24 lg:space-y-32 animate-fade-in">
      <div className="text-center space-y-12">
        ...
        <div className="space-y-10">
          ...
          <p className="text-xl md:text-3xl text-white max-w-4xl mx-auto font-medium leading-relaxed">사람들이 검색으로 해결하려는 반복적인 문제의<br className="hidden md:block" />질문을 <span className="text-white font-black text-2xl md:text-4xl border-b-4 border-indigo-500/80 pb-2">이플림의 아카이브</span>로 정제합니다.</p>
        </div>
      </div>
